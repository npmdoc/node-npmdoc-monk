...
1.  [function <span class="apidocSignatureSpan"></span>monk (uri, opts, fn)](#apidoc.element.monk.monk)
...
1.  [function <span class="apidocSignatureSpan">monk.</span>toString ()](#apidoc.element.monk.toString)
...
#### <a name="apidoc.element.monk.monk"></a>[function <span class="apidocSignatureSpan"></span>monk (uri, opts, fn)](#apidoc.element.monk.monk)
...
#### <a name="apidoc.element.monk.toString"></a>[function <span class="apidocSignatureSpan">monk.</span>toString ()](#apidoc.element.monk.toString)
- description and source-code
```javascript
toString = function () {
    return toString;
